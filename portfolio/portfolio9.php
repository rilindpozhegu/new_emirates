...
<head>
    ...
    <title>Swiss Canonica UAE</title>
...
<section class="first_section_port" id="go_top">
    <div class="container">
        <div class="row">
            <div class="col-md-5">
                <h1 class="red_tittle_portfolio wow fadeInUp" data-wow-duration="0.5s" data-wow-delay=".2s">Swiss Canonica UAE</h1>
            </div>
            <div class="col-md-7">
                <p class="portfolio_paragraphs wow fadeInUp" data-wow-duration="0.5s" data-wow-delay=".3s">Settled in Dubai since 2014, SWISSCANONICA UAE is part of the SWISSCANONICA Group, founded in Geneva – Switzerland- in 1948 by Mr. André CANONICA. The company, a family run business, is active in the airport catering and retail sectors but also in the chocolate manufacturing and the Food &Beverage consulting.</p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-7 wow fadeInUp" data-wow-duration="0.5s" data-wow-delay=".2s">
                <img src="img/swiss_uae/swiss_uae_p1-01.png" class="img-responsive">
            </div>
...
<section class="section_three_portfolio">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-7 wow fadeInUp" data-wow-duration="0.5s" data-wow-delay=".2s">
                <img src="img/swiss_uae/swiss_uae_p2-01.png" class="img-responsive">
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 wow fadeInUp" data-wow-duration="0.5s" data-wow-delay=".2s">
                <img src="img/swiss_uae/swiss_uae_p3-01.png" class="img-responsive">
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-7 wow fadeInUp" data-wow-duration="0.5s" data-wow-delay=".3s">
                <img src="img/swiss_uae/swiss_uae_p4-01.png" class="img-responsive">
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 col-xs-4">
                <a href="#go_top">
                    <a href="portfolio8.php"><button><i class="fa fa-angle-left" aria-hidden="true"></i> Previous Project</button></a>
                </a>
            </div>
            <div class="col-md-4 col-xs-4">
                <a href="">
            ...
            <div class="col-md-4 col-xs-4">
                <a href="">
                    <a href="portfolio10.php"><button>Next Project <i class="fa fa-angle-right" aria-hidden="true"></i></button></a>
                </a>
            </div>
        </div>
    </div>
