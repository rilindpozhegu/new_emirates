    ...
    <div class="container">
        <div class="row">
            <div class="col-md-7 wow fadeInUp" data-wow-duration="0.5s" data-wow-delay=".2s">
                <img src="img/landscape/landscape_p1-01.png" class="img-responsive">
            </div>
            <div class="col-md-5 wow fadeInUp" data-wow-duration="0.5s" data-wow-delay=".3s">
                ...
                <a href="http://www.emirateslandscape.com/" target="_blank"><button class="button_style_red_md button_main button__aylen">Visit Website</button></a>
            </div>
        </div>
    </div>
</section>
...
<section class="section_three_portfolio">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 col-md-offset-1 wow fadeInUp" data-wow-duration="0.5s" data-wow-delay=".2s">
                <img src="img/landscape/landscape_p2-01.png" class="img-responsive">
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 wow fadeInUp" data-wow-duration="0.5s" data-wow-delay=".2s">
                <img src="img/landscape/landscape_p34-01.png" class="img-responsive">
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 wow fadeInUp" data-wow-duration="0.5s" data-wow-delay=".3s">
                <p class="portfolio_paragraphs">From branding to marketing, let us help you create the right image and reach your customers in the right way and you focus on what you do best.</p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-7 wow fadeInUp" data-wow-duration="0.5s" data-wow-delay=".3s">
                <img src="img/landscape/landscape_p4-01.png" class="img-responsive">
            </div>
        </div>
    </div>
</section>
...
<section class="last_buttons_portfolio">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 col-xs-4">
                <a href="">
                    <a href="portfolio6.php"><button>Next Project <i class="fa fa-angle-right" aria-hidden="true"></i></button></a>
                </a>
            </div>
        </div>
    </div>
