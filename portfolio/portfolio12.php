...
<section class="first_section_port" id="go_top">
    <div class="container">
        <div class="row">
            <div class="col-md-5">
                <h1 class="red_tittle_portfolio wow fadeInUp" data-wow-duration="0.5s" data-wow-delay=".2s">Horizon Drone</h1>
            </div>
            <div class="col-md-7">
                <p class="portfolio_paragraphs wow fadeInUp" data-wow-duration="0.5s" data-wow-delay=".3s">Horizon Drone is a company specializing in the development of new technologies using drones for public and private use as well as in the field of realization of aerial shots through photos and videos.</p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-7 wow fadeInUp" data-wow-duration="0.5s" data-wow-delay=".2s">
                <img src="img/horizon/horizon_p1-01.png" class="img-responsive">
            </div>
            <div class="col-md-5 wow fadeInUp" data-wow-duration="0.5s" data-wow-delay=".3s" style="padding-top: 2%;">
...
<section class="section_three_portfolio">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-7 wow fadeInUp" data-wow-duration="0.5s" data-wow-delay=".2s">
                <img src="img/horizon/horizon_p2-01.png" class="img-responsive">
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 wow fadeInUp" data-wow-duration="0.5s" data-wow-delay=".2s">
                <img src="img/horizon/horizon_p3-01.png" class="img-responsive">
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-7 wow fadeInUp" data-wow-duration="0.5s" data-wow-delay=".3s">
                <img src="img/horizon/horizon_p4-01.png" class="img-responsive">
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 col-xs-4">
                <a href="#go_top">
                    <a href="portfolio11.php"><button><i class="fa fa-angle-left" aria-hidden="true"></i> Previous Project</button></a>
                </a>
            </div>
            <div class="col-md-4 col-xs-4">
                <a href="">
            ...
            <div class="col-md-4 col-xs-4">
                <a href="">
                    <a href="portfolio1.php"><button>Next Project <i class="fa fa-angle-right" aria-hidden="true"></i></button></a>
                </a>
            </div>
        </div>
    </div>
