    ...
    <div class="container">
        <div class="row">
            <div class="col-md-7 wow fadeInUp" data-wow-duration="0.5s" data-wow-delay=".2s">
                <img src="img/swiss_world/swiss_world_p1-01.png" class="img-responsive">
            </div>
...
<section class="section_three_portfolio">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-7 wow fadeInUp" data-wow-duration="0.5s" data-wow-delay=".2s">
                <img src="img/swiss_world/swiss_world_p2-01.png" class="img-responsive">
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 wow fadeInUp" data-wow-duration="0.5s" data-wow-delay=".2s">
                <img src="img/swiss_world/swiss_world_p3-01.png" class="img-responsive">
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-7 wow fadeInUp" data-wow-duration="0.5s" data-wow-delay=".3s">
                <img src="img/swiss_world/swiss_world_p4-01.png" class="img-responsive">
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 col-xs-4">
                <a href="#go_top">
                    <a href="portfolio7.php"><button><i class="fa fa-angle-left" aria-hidden="true"></i> Previous Project</button></a>
                </a>
            </div>
            <div class="col-md-4 col-xs-4">
                <a href="">
            ...
            <div class="col-md-4 col-xs-4">
                <a href="">
                    <a href="portfolio9.php"><button>Next Project <i class="fa fa-angle-right" aria-hidden="true"></i></button></a>
                </a>
            </div>
        </div>
    </div>
