...
<head>
    ...
    <title>Nationality Advisor</title>
...
<section class="first_section_port" id="go_top">
    <div class="container">
        <div class="row">
            <div class="col-md-5">
                <h1 class="red_tittle_portfolio wow fadeInUp" data-wow-duration="0.5s" data-wow-delay=".2s">Nationality Advisor</h1>
            </div>
            <div class="col-md-7">
                <p class="portfolio_paragraphs wow fadeInUp" data-wow-duration="0.5s" data-wow-delay=".3s">Henley & Partners is the global leader in residence and citizenship planning. Each year, hundreds of wealthy individuals, families and their advisors rely on our expertise and experience in this area. Our highly qualified professionals work together as one team in over 25 offices worldwide.</p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-7 wow fadeInUp" data-wow-duration="0.5s" data-wow-delay=".2s">
                <img src="img/nationality/nationality_p1-01.png" class="img-responsive">
            </div>
...
<section class="section_three_portfolio">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-7 wow fadeInUp" data-wow-duration="0.5s" data-wow-delay=".2s">
                <img src="img/nationality/nationality_p2-01.png" class="img-responsive">
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 wow fadeInUp" data-wow-duration="0.5s" data-wow-delay=".2s">
                <img src="img/nationality/nationality_p3-01.png" class="img-responsive">
            </div>
        </div>
    </div>
</section> -->
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-7 wow fadeInUp" data-wow-duration="0.5s" data-wow-delay=".3s">
                <img src="img/nationality/nationality_p4-01.png" class="img-responsive">
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 col-xs-4">
                <a href="#go_top">
                    <a href="portfolio6.php"><button><i class="fa fa-angle-left" aria-hidden="true"></i> Previous Project</button></a>
                </a>
            </div>
            <div class="col-md-4 col-xs-4">
                <a href="">
            ...
            <div class="col-md-4 col-xs-4">
                <a href="">
                    <a href="portfolio8.php"><button>Next Project <i class="fa fa-angle-right" aria-hidden="true"></i></button></a>
                </a>
            </div>
        </div>
    </div>
