...
<section class="first_section_port" id="go_top">
    <div class="container">
        <div class="row">
            <div class="col-md-5">
                <h1 class="red_tittle_portfolio wow fadeInUp" data-wow-duration="0.5s" data-wow-delay=".2s">Utopia</h1>
            </div>
            <div class="col-md-7">
                <p class="portfolio_paragraphs wow fadeInUp" data-wow-duration="0.5s" data-wow-delay=".3s">Utopia was founded by industry experts who specialize in creating Innovative, sophisticated and cutting edge events. With over 10 years of experience under our belt, Utopia has developed extensive knowledge and understanding of event creation, art and hospitality.</p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-7 wow fadeInUp" data-wow-duration="0.5s" data-wow-delay=".2s">
                <img src="img/utopia/utopia_p1-01.png" class="img-responsive">
            </div>
            <div class="col-md-5 wow fadeInUp" data-wow-duration="0.5s" data-wow-delay=".3s">
                ...
                <a href="http://www.utopia-uae.com/" target="_blank"><button class="button_style_red_md button_main button__aylen">Visit Website</button></a>
            </div>
        </div>
    </div>
</section>
...
<section class="section_three_portfolio">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-7 wow fadeInUp" data-wow-duration="0.5s" data-wow-delay=".2s">
                <img src="img/utopia/utopia_p2-01.png" class="img-responsive">
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 wow fadeInUp" data-wow-duration="0.5s" data-wow-delay=".2s">
                <img src="img/utopia/utopia_p34-01.png" class="img-responsive">
            </div>
        </div>
    </div>
</section>
...
<section class="section_six_portfolio">
    <div class="container">
        <div class="row">
            <div class="col-md-5" style="padding-top: 14%;">
            ...
            <div class="col-md-7 wow fadeInUp" data-wow-duration="0.5s" data-wow-delay=".3s">
                <img src="img/utopia/utopia_p5-01.png" class="img-responsive">
            </div>
        </div>
    </div>
</section>
