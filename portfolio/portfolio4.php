...
<head>
    ...
    <title>Swiss Canonica Chocolate</title>
...
<body id="parallax_slide_bg" data-spy="scroll" data-target=".navbar-fixed-top" class="portfolio_body_all">


<!-- Portfolio first section title and paragraph -->

<section class="first_section_port" id="go_top">
    <div class="container">
        <div class="row">
            <div class="col-md-5">
                <h1 class="red_tittle_portfolio wow fadeInUp" data-wow-duration="0.5s" data-wow-delay=".2s">Swiss Canonica Chocolate</h1>
            </div>
            <div class="col-md-7">
                <p class="portfolio_paragraphs wow fadeInUp" data-wow-duration="0.5s" data-wow-delay=".3s">In its Geneva ateliers, Canonica lovingly cultivates its outstanding savoir-faire, based on long-standing traditions of Swiss chocolate-making - all so we can share our passion with you for chocolate of exceptional quality.  </p>
            </div>
        </div>
    </div>
</section>
...
<section class="second_section_portfolio">
    <div class="container">
        <div class="row">
            <div class="col-md-7 wow fadeInUp" data-wow-duration="0.5s" data-wow-delay=".2s">
                <img src="img/chocolate/chocolate_p1-01.png" class="img-responsive">
            </div>
            <div class="col-md-5 wow fadeInUp" data-wow-duration="0.5s" data-wow-delay=".3s" style="padding-top: 3%;">
                ...
                <a href="#" target="_blank"><button class="button_style_red_md button_main button__aylen">Visit Website</button></a>
            </div>
        </div>
    </div>
</section>
...
<section class="section_three_portfolio">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-7 wow fadeInUp" data-wow-duration="0.5s" data-wow-delay=".2s">
                <img src="img/chocolate/chocolate_p2-01.png" class="img-responsive">
            </div>
        </div>
    </div>
</section>
...
<section class="section_four_portfolio">
    <div class="container">
        <div class="row">
            <div class="col-md-12 wow fadeInUp" data-wow-duration="0.5s" data-wow-delay=".2s">
                <img src="img/chocolate/chocolate_p3-01.png" class="img-responsive">
            </div>
        </div>
    </div>
</section>

<!-- <section class="section_five_portfolio">
    <div class="container">
        <div class="row">
            <div class="col-md-6 wow fadeInUp" data-wow-duration="0.5s" data-wow-delay=".2s">
                <h3 class="second_title_portfolioh3">Boost your presence with <br> your brand identity!</h3>
            </div>
...
<section class="section_six_portfolio">
    <div class="container">
        <div class="row">
            <div class="col-md-5" style="padding-top: 11%;">
                ...
                <a href="#" target="_blank"><button class="button_style_red_md button_main button__aylen wow fadeInUp" data-wow-duration="0.5s" data-wow-delay=".3s">Visit Website</button></a>
            </div>
            <div class="col-md-7 wow fadeInUp" data-wow-duration="0.5s" data-wow-delay=".3s">
                <img src="img/chocolate/chocolate_p4-01.png" class="img-responsive">
            </div>
        </div>
    </div>
</section>
...
<section class="last_buttons_portfolio">
    <div class="container">
        <div class="row">
            <div class="col-md-4 col-xs-4">
                <a href="#go_top">
                    <a href="portfolio4.php"><button><i class="fa fa-angle-left" aria-hidden="true"></i> Previous Project</button></a>
                </a>
            </div>
            <div class="col-md-4 col-xs-4">
                <a href="">
            ...
            <div class="col-md-4 col-xs-4">
                <a href="">
                    <a href="portfolio5.php"><button>Next Project <i class="fa fa-angle-right" aria-hidden="true"></i></button></a>
                </a>
            </div>
        </div>
    </div>
